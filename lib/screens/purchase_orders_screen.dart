...
class _PurchaseOrdersScreenState extends State<PurchaseOrdersScreen> {
  ...
  final List<String> _statuses = [
    'All', 'Pending', 'Ordered', 'Partially Received', 'Received', 'Cancelled'
  ];
  ...
  Future<void> _cancelOrder(PurchaseOrder order) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('This will mark the order as Cancelled. Stock will NOT be affected.'),
        actions: [
  ...
  void _viewOrder(PurchaseOrder order) {
    showDialog(
      ...
      builder: (_) => _OrderDetailDialog(
        order: order,
        onMarkReceived: order.status != 'Received' && order.status != 'Cancelled'
            ? () { Navigator.pop(context); _postOrder(order); }
            : null,
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            const ExecutiveHeader(
              ...
              subtitle: 'Create and manage stock purchases. Mark as Received to auto-update inventory.',
            ),
                              ...
                              ListView.separated(
                                ...
                                itemBuilder: (_, i) {
                                  ...
                                  return _OrderRow(
                                    order: o,
                                    onView: () => _viewOrder(o),
                                    onEdit: (o.status == 'Pending' || o.status == 'Ordered') ? () => _editOrder(o) : null,
                                    onCancel: (o.status != 'Cancelled' && o.status != 'Received') ? () => _cancelOrder(o) : null,
                                    onReceive: (o.status != 'Received' && o.status != 'Cancelled') ? () => _postOrder(o) : null,
                                  );
                                },
                              ),
                            ],
      ...
      child: AnimatedContainer(
        ...
        child: Row(children: [
          Expanded(flex: 2, child: Text(o.poNumber,
              style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Color(0xFF1A2E2B)))),
          Expanded(flex: 3, child: Text(o.supplier,
              style: TextStyle(fontSize: 14, color: Colors.grey.shade800))),
          Expanded(flex: 2, child: Text(fmt.format(o.orderDate),
              style: TextStyle(fontSize: 13, color: Colors.grey.shade600))),
          Expanded(flex: 2, child: Text(currency.format(o.totalAmount),
            ...
            child: Row(
              ...
              children: [
                if (widget.onReceive != null) ...[
                  _RowBtn(icon: Icons.upload_rounded, tooltip: 'Post',
                      color: Colors.green.shade600, onTap: widget.onReceive),
                  const SizedBox(width: 6),
                ],
                _RowBtn(icon: Icons.visibility_outlined, tooltip: 'View', onTap: widget.onView),
                if (widget.onEdit != null) ...[
                  const SizedBox(width: 6),
                  _RowBtn(icon: Icons.edit_outlined, tooltip: 'Edit', onTap: widget.onEdit),
                ],
                if (widget.onCancel != null) ...[
                  const SizedBox(width: 6),
                  _RowBtn(icon: Icons.cancel_outlined, tooltip: 'Cancel',
                      color: Colors.red.shade600, onTap: widget.onCancel),
                ],
              ],
            ),
          ),
...
class _RowBtn extends StatelessWidget {
  ...
  const _RowBtn({required this.icon, required this.tooltip, this.color, this.onTap});
      ...
      child: Center(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const Text('No purchase orders yet',
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Color(0xFF1A2E2B))),
          const SizedBox(height: 8),
          Text('Click "New Purchase Order" to get started.',
...
class _OrderDetailDialog extends StatelessWidget {
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(colors: [Color(0xFF0F4C81), Color(0xFF1976D2)],
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  child: Column(children: [
                    ...
                    ...order.items.asMap().entries.map((e) {
                      ...
                      return Container(
                        ...
                        child: Row(children: [
                          Expanded(flex: 4, child: Text(i.productName, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w500))),
                          Expanded(flex: 2, child: Text(i.unitPurchased, style: TextStyle(fontSize: 13, color: Colors.grey.shade600))),
                          Expanded(flex: 1, child: Text('${i.quantity.toInt()}', style: const TextStyle(fontSize: 13))),
                          Expanded(flex: 2, child: Text(currency.format(i.purchasePrice), style: const TextStyle(fontSize: 13))),
                          Expanded(flex: 2, child: Text(currency.format(i.subtotal),
                ...
                if (order.notes?.isNotEmpty == true) ...[
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      const Icon(Icons.notes_rounded, size: 16, color: Color(0xFF0369A1)),
                      const SizedBox(width: 8),
              ...
              if (onMarkReceived != null) ...[
                ...
                Expanded(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: const Text('Post Order', style: TextStyle(fontWeight: FontWeight.w700)),
                    style: ElevatedButton.styleFrom(
  ...
  Widget _th(String t) => Text(t, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Colors.grey.shade600));
}
...
class _Meta extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    ...
    const SizedBox(height: 2),
    Text(value, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: color ?? const Color(0xFF1A2E2B))),
  ]);
}
...
class _TotalRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      ...
      Text(value, style: TextStyle(fontSize: 13, fontWeight: bold ? FontWeight.w800 : FontWeight.w600, color: color ?? const Color(0xFF1A2E2B))),
    ]),
  );
}
...
class _OrderFormDialogState extends State<_OrderFormDialog> {
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(isEdit ? 'Modify the order details below.' : 'Record a new stock purchase from a supplier.',
                ...
                Expanded(
                  ...
                  child: Column(children: [
                    ...
                    _Card(
                      ...
                      subtitle: 'Enter supplier name and reference info.',
                      child: Column(children: [
                        _LabelField(
                          label: 'Supplier Name *',
                    ...
                    _Card(
                      ...
                      trailing: TextButton.icon(
                        onPressed: widget.products.isEmpty ? null : _addItem,
                  ...
                  child: Column(children: [
                    _Card(
                      ...
                      child: Column(children: [
                        ...
                        const SizedBox(height: 6),
                        _SumRow('Total', _currency.format(_total), bold: true),
                        if (_balance > 0) ...[
                          const SizedBox(height: 6),
                          _SumRow('Balance', _currency.format(_balance), color: Colors.red.shade600),
                        ],
                      ]),
                    ),
                  ]),
            ...
            child: Row(children: [
              ...
              Expanded(
                ...
                child: ElevatedButton(
                  onPressed: (_selectedSupplier == null || _selectedSupplier!.isEmpty || _items.isEmpty || _saving)
                      ? null : _save,
                  style: ElevatedButton.styleFrom(
                  ...
                  child: Text(isEdit ? 'Save Changes' : 'Create Purchase Order',
  ...
  InputDecoration _dec(String hint) => InputDecoration(
    ...
    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: const BorderSide(color: Color(0xFF0F4C81), width: 1.5)),
              ...
              Expanded(
                ...
                child: _LabelField(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      _units.contains(r.unitPurchased) ? r.unitPurchased : _units.first,
                      style: const TextStyle(fontSize: 14, color: Color(0xFF1A2E2B)),
                    ),
                  ),
                ),
...
class _Card extends StatelessWidget {
  ...
  const _Card({required this.title, this.subtitle, required this.child, this.trailing});
...
class _SummaryField extends StatelessWidget {
  ...
  const _SummaryField({required this.label, required this.controller, required this.onChanged});
